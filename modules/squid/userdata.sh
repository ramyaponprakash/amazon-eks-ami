...
install_squid() {
    ...
    aws s3 cp s3://sdx-squid/squid-5.7-1.el7.x86_64.rpm /home/ec2-user/tmp/squid-5.7-1.el7.x86_64.rpm --no-progress
    rpm -Uvh /home/ec2-user/tmp/squid-5.7-1.el7.x86_64.rpm
    aws s3 cp s3://sdx-squid/config/grp-squid-mod.sh /home/ec2-user/tmp/grp-squid-mod.sh --no-progress
    /bin/bash -x /home/ec2-user/tmp/grp-squid-mod.sh 2>&1 >> /home/ec2-user/tmp/grp-squid-mod.log
