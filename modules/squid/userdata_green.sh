...
install_squid() {
    ...
    aws s3 cp s3://sdx-squid/config/grp-squid-rhel8-mod.sh /home/ec2-user/tmp/grp-squid-rhel8-mod.sh --no-progress
    #/bin/bash -x /home/ec2-user/tmp/grp-squid-rhel8-mod.sh 2>&1 >> /home/ec2-user/tmp/grp-squid-mod.log
    aws s3 cp s3://sdx-stackops-installation-prod/squid/install_SQUID.sh /home/ec2-user/tmp/install_SQUID.sh --no-progress
    /bin/bash -x /home/ec2-user/tmp/install_SQUID.sh 2>&1 >> /home/ec2-user/tmp/install_SQUID.log
