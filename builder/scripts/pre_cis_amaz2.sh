...
# https://github.com/aws-samples/amazon-eks-custom-amis/blob/main/scripts/cis-benchmark.sh
...
#!/bin/sh
cat <<"EOF"
You are accessing a system managed by the Government of Singapore and/or Government Technology Agency of Singapore (GovTech), is provided for authorized use only. All activity may be monitored and reported.
Any unauthorised access or use of this system is prohibited and may be subject to disciplinary action and/or criminal prosecution.
EOF
OUTEREOF
